...
<link href="${base}/resources/shop/css/daterangepicker.min.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${base}/resources/shop/js/moment.min.js"></script>
<script type="text/javascript" src="${base}/resources/shop/js/jquery.daterangepicker.js"></script>
<script type="text/javascript" src="${base}/resources/shop/js/jquery.daterangepicker.min.js"></script>
						...
						[#if product.hasSpecification()]
							...
							<div id="specification" class="specification clearfix">
								...
								[#list product.specificationItems as specificationItem]
									[#if "${customCategory}"=="酒店预订"]
									<div class="form-group" style="overflow: hidden;">
										<div style="float: left;color:#888888;">入住时间：</div>
										<div style="float: left;">
											<input type="text" name="date2" id="date2" class="form-control" style="margin-top: 8px;">
