...
<body>
	...
	<div class="container productList">
		<div id="compareBar" class="compareBar" style="border:2px solid red;">
			<form action="${base}/product/compare" method="get">
				<dl>
					<dt>${message("shop.product.compareBar")}</dt>
					<dd class="action">
						<a href="javascript:;" class="submit">${message("shop.product.compareSubmit")}哈哈哈</a>
						...
						[#if page.content?has_content]
							<ul>
								[#list page.content as product]
									...
									<li>
										<a href="${base}${product.path}?customCategory=${customCategory}">
