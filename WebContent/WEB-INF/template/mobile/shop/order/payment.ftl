		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a class="btn btn-primary" href="${base}/member/order/view?orderSn=${order.sn}">${message("shop.order.paid")}</a>
		...
		<div class="container-fluid">
			...
			[#if order.paymentMethod.method == "online"]
				[#if paymentPlugins?has_content]
					<form id="paymentForm" action="${base}/payment/plugin_submit" method="post" target="_blank">
