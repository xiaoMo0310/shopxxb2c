		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-3 text-center">
					...
					<a href="${base}/">${message("shop.index.index")}</a>
				</div>
				<div class="col-xs-3 text-center active">
					<span class="glyphicon glyphicon-th-list"></span>
					<a href="${base}/product_category">${message("shop.index.productCategory")}</a>
				</div>
				<div class="col-xs-3 text-center">
				...
				<div class="col-xs-3 text-center">
					...
					<a href="${base}/member/index">${message("shop.index.member")}</a>
				</div>
			</div>
		</div>
	</footer>
