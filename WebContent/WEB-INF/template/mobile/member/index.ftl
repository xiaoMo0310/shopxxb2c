		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-3 text-center">
					...
					<a href="${base}/">${message("member.index.index")}</a>
				</div>
				<div class="col-xs-3 text-center">
					<span class="glyphicon glyphicon-th-list"></span>
					<a href="${base}/product_category">${message("member.index.productCategory")}</a>
				</div>
				<div class="col-xs-3 text-center">
					<span class="glyphicon glyphicon-shopping-cart"></span>
					<a href="${base}/cart/list">${message("member.index.cart")}</a>
				</div>
				<div class="col-xs-3 text-center active">
					<span class="glyphicon glyphicon-user"></span>
					<a href="${base}/member/index">${message("member.index.member")}</a>
				</div>
			</div>
		</div>
	</footer>
