...
<head>
	...
	<title>${message("member.message.list")}[#if showPowered] - Powered By SHOP++[/#if]</title>
		...
		<%_.each(messages, function(message, i) {%>
			<div class="panel panel-flat">
				...
				<div class="panel-footer text-right">
					<a class="btn btn-sm btn-default" href="view?messageId=<%-message.id%>">${message("member.common.view")}</a>
