			...
			<div class="bodyRight">
				<table>
					...
					<tr>
						<td>数据库密码:</td>
						<td>
							<input type="password" id="databasePassword" name="databasePassword" class="text" maxlength="200" autocomplete="off" />
						</td>
					</tr>
					<tr>
						<td>数据库名称:</td>
						<td>
							<input type="text" id="databaseName" name="databaseName" class="text" value="shopxxb2c" maxlength="200" />
							<span class="requireField">*</span>
						</td>
					</tr>
				</table>
				<table>
					...
					<tr>
						<td>密码:</td>
						<td>
							<input type="password" id="adminPassword" name="adminPassword" class="text" maxlength="20" autocomplete="off" />
							<span class="requireField">*</span>
						</td>
					</tr>
					<tr>
						<td>重复密码:</td>
						<td>
							<input type="password" id="reAdminPassword" name="reAdminPassword" class="text" maxlength="20" autocomplete="off" />
							<span class="requireField">*</span>
						</td>
					</tr>
				</table>
				<table>
					...
					<tr>
						...
						<td>
							<input type="checkbox" id="createDatabase" name="createDatabase" value="true" checked="checked" />
						</td>
					</tr>
					<tr>
						<td>初始化DEMO数据:</td>
