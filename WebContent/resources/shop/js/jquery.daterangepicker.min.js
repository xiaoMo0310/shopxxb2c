...
!function (e) {
    ...
    e.dateRangePickerLanguages = {
        ...
        function r() {
            ...
            function o(t) {
                var n = e(t).parents("table").hasClass("month2"), r = n ? a.month2 : a.month1;
                r = H(r), n && N(r, a.month1) <= 0 || _(r) || (Y(r, n ? "month2" : "month1"), W())
            }
            ...
            e(this).data("date-picker-opened", !0), re = q().hide(), re.append('<div class="date-range-length-tip"></div>'), re.delegate(".day", "mouseleave", function () {
                re.find(".date-range-length-tip").hide(), a.singleDate && x()
            }), e(a.container).append(re), a.inline ? re.addClass("inline-wrapper") : s(), a.alwaysOpen && re.find(".apply-btn").hide();
            var m = ae();
            if (ne(m), a.time.enabled) if (a.startDate && a.endDate || a.start && a.end) P(t(a.start || a.startDate).toDate(), "time1"), P(t(a.end || a.endDate).toDate(), "time2"); else {
                var c = a.defaultEndTime ? a.defaultEndTime : m;
                P(m, "time1"), P(c, "time2")
            }
            var h = "";
            h = te(a.singleDate ? "default-single" : a.minDays && a.maxDays ? "default-range" : a.minDays ? "default-more" : a.maxDays ? "default-less" : "default-default"), re.find(".default-top").html(h.replace(/\%d/, a.minDays).replace(/\%d/, a.maxDays)), a.singleMonth ? re.addClass("single-month") : re.addClass("two-months"), setTimeout(function () {
                u(), oe = !0
                ...
                a.start = !1, a.end = !1, re.find(".day.checked").removeClass("checked"), a.setValue.call(le, t), z(), C(!0), S(), a.autoClose && A()
        ...
        function s() {
            if (!a.inline) {
                ...
                if ("relative" == e(a.container).css("position")) {
                    ...
                    re.css({top: t.top - n.top + e(de).outerHeight() + 4, left: t.left - n.left})
        ...
        function d() {
            var e = a.getValue.call(le), n = e ? e.split(a.separator) : "";
            if (n && (1 == n.length && a.singleDate || n.length >= 2)) {
                var r = a.format;
                r.match(/Do/) && (r = r.replace(/Do/, "D"), n[0] = n[0].replace(/(\d+)(th|nd|st)/, "$1"), n.length >= 2 && (n[1] = n[1].replace(/(\d+)(th|nd|st)/, "$1"))), oe = !1, n.length >= 2 ? T(l(n[0], r, t.locale(a.language)), l(n[1], r, t.locale(a.language))) : 1 == n.length && a.singleDate && j(l(n[0], r, t.locale(a.language))), oe = !0
            }
        }
        ...
        function u() {
            ...
            e && (e = parseInt(e));
            var t = re.find(".month1").width(), a = re.find(".gap").width() + (e ? 2 * e : 0),
        ...
        function D(t) {
            ...
            if (t.hasClass("has-tooltip") && t.attr("data-tooltip")) r = '<span style="white-space:nowrap">' + t.attr("data-tooltip") + "</span>"; else if (!t.hasClass("invalid")) if (a.singleDate) re.find(".day.hovering").removeClass("hovering"), t.addClass("hovering"); else if (re.find(".day").each(function () {
            ...
            if (r) {
                var i = t.offset(), o = re.offset(), d = i.left - o.left, l = i.top - o.top;
                d += t.width() / 2;
        ...
        function C(t, n) {
            re.find(".start-day").html("..."), re.find(".end-day").html("..."), re.find(".selected-days").hide(), a.start && re.find(".start-day").html(V(new Date(parseInt(a.start)))), a.end && re.find(".end-day").html(V(new Date(parseInt(a.end))));
            var r;
        ...
        function T(e, t, n) {
            ...
            var s = !0;
            return a.startDate && L(e, a.startDate) < 0 && (s = !1), a.endDate && L(t, a.endDate) > 0 && (s = !1), s ? (a.start = e.getTime(), a.end = t.getTime(), a.time.enabled && (m("time1", e), m("time2", t)), (a.stickyMonths || L(e, t) > 0 && 0 === N(e, t)) && (a.lookBehind ? e = H(t) : t = F(e)), a.stickyMonths && N(t, a.endDate) > 0 && (e = H(e), t = H(t)), a.stickyMonths || 0 === N(e, t) && (a.lookBehind ? e = H(t) : t = F(e)), Y(e, "month1"), Y(t, "month2"), W(), z(), C(!1, n), void M()) : (Y(a.startDate, "month1"), Y(F(a.startDate), "month2"), void W())
        }
        ...
        function Y(e, n) {
            e = t(e).toDate();
            var r = I(e.getMonth());
            re.find("." + n + " .month-name").html(r + " " + e.getFullYear()), re.find("." + n + " tbody").html(Z(e)), a[n] = e, b()
        }
        ...
        function W() {
            ...
            var i = re.find("table.month1").height(), o = re.find("table.month2").height();
        ...
        function q() {
            ...
            a.extraClass && (t += " " + a.extraClass + " "), a.singleDate && (t += " single-date "), a.showShortcuts || (t += " no-shortcuts "), a.showTopbar || (t += " no-topbar "), a.customTopBar && (t += " custom-topbar "), t += '">', a.showTopbar && (t += '<div class="drp_top-bar">', a.customTopBar ? ("function" == typeof a.customTopBar && (a.customTopBar = a.customTopBar()), t += '<div class="custom-top">' + a.customTopBar + "</div>") : (t += '<div class="normal-top"><span style="color:#333">' + te("selected") + ' </span> <b class="start-day">...</b>', a.singleDate || (t += ' <span class="separator-day">' + a.separator + '</span> <b class="end-day">...</b> <i class="selected-days">(<span class="selected-days-num">3</span> ' + te("days") + ")</i>"),
                t += "</div>", t += '<div class="error-top">error</div><div class="default-top">default</div>'), t += '<input type="button" class="apply-btn disabled' + $() + '" value="' + te("apply") + '" />', t += "</div>");
            ...
            if (t += '<div class="month-wrapper"><table class="month1" cellspacing="0" border="0" cellpadding="0"><thead><tr class="caption"><th style="width:27px;"><span class="prev">&lt;</span></th><th colspan="' + n + '" class="month-name"></th><th style="width:27px;">' + (a.singleDate || !a.stickyMonths ? '<span class="next">&gt;</span>' : "") + '</th></tr><tr class="week-name">' + E() + "</thead><tbody></tbody></table>", G() && (t += '<div class="gap">' + J() + '</div><table class="month2" cellspacing="0" border="0" cellpadding="0"><thead><tr class="caption"><th style="width:27px;">' + (a.stickyMonths ? "" : '<span class="prev">&lt;</span>') + '</th><th colspan="' + n + '" class="month-name"></th><th style="width:27px;"><span class="next">&gt;</span></th></tr><tr class="week-name">' + E() + "</thead><tbody></tbody></table>"), t += '<div style="clear:both;height:0;font-size:0;"></div><div class="time"><div class="time1"></div>', a.singleDate || (t += '<div class="time2"></div>'), t += '</div><div style="clear:both;height:0;font-size:0;"></div></div>', t += '<div class="footer">', a.showShortcuts) {
                ...
                if (r) {
                    ...
                    if (r["prev-days"] && r["prev-days"].length > 0) {
                        ...
                        for (var i = 0; i < r["prev-days"].length; i++) s = r["prev-days"][i], s += te(r["prev-days"][i] > 1 ? "days" : "day"), t += ' <a href="javascript:;" shortcut="day,-' + r["prev-days"][i] + '">' + s + "</a>";
                        t += "</span>"
                    }
                    if (r["next-days"] && r["next-days"].length > 0) {
                        t += '&nbsp;<span class="next-days">' + te("following");
                        for (var i = 0; i < r["next-days"].length; i++) s = r["next-days"][i], s += te(r["next-days"][i] > 1 ? "days" : "day"), t += ' <a href="javascript:;" shortcut="day,' + r["next-days"][i] + '">' + s + "</a>";
                        t += "</span>"
                    }
                    if (r.prev && r.prev.length > 0) {
                        t += '&nbsp;<span class="prev-buttons">' + te("previous");
                        for (var i = 0; i < r.prev.length; i++) s = te("prev-" + r.prev[i]), t += ' <a href="javascript:;" shortcut="prev,' + r.prev[i] + '">' + s + "</a>";
                        t += "</span>"
                    }
                    if (r.next && r.next.length > 0) {
                        t += '&nbsp;<span class="next-buttons">' + te("next");
                        for (var i = 0; i < r.next.length; i++) s = te("next-" + r.next[i]), t += ' <a href="javascript:;" shortcut="next,' + r.next[i] + '">' + s + "</a>";
                        t += "</span>"
                    }
                }
        ...
        function Z(e) {
            ...
            if (s > 0) for (var d = s; d > 0; d--) {
                ...
                o = w(l.getTime()), a.startDate && L(l, a.startDate) < 0 && (o = !1), a.endDate && L(l, a.endDate) > 0 && (o = !1), n.push({
                    date: l,
                    type: "lastMonth",
                    day: l.getDate(),
                    time: l.getTime(),
            ...
            for (var u = e.getMonth(), d = 0; 40 > d; d++) i = t(e).add(d, "days").toDate(), o = w(i.getTime()), a.startDate && L(i, a.startDate) < 0 && (o = !1), a.endDate && L(i, a.endDate) > 0 && (o = !1), n.push({
                date: i,
            ...
            for (var m = [], c = 0; 6 > c && "nextMonth" != n[7 * c].type; c++) {
                ...
                for (var l = 0; 7 > l; l++) {
                    ...
                    0 === l && a.showWeekNumbers && m.push('<td><div class="week-number" data-start-time="' + i.time + '">' + a.getWeekNumber(i.date) + "</div></td>"), m.push("<td " + K({}, a.dayTdAttrs, i) + "><div " + K(v, a.dayDivAttrs, i) + ">" + X(i.time, i.day) + "</div></td>")
                }
                m.push("</tr>")
            }
            return m.join("")
        ...
        function te(t) {
            var a = t.toLowerCase(), n = t in ie ? ie[t] : a in ie ? ie[a] : null,
        ...
        function ae() {
            ...
            return a.lookBehind ? (a.startDate && N(e, a.startDate) < 0 && (e = F(t(a.startDate).toDate())), a.endDate && N(e, a.endDate) > 0 && (e = t(a.endDate).toDate())) : (a.startDate && N(e, a.startDate) < 0 && (e = t(a.startDate).toDate()), a.endDate && N(F(e), a.endDate) > 0 && (e = H(t(a.endDate).toDate()))), a.singleDate && (a.startDate && N(e, a.startDate) < 0 && (e = t(a.startDate).toDate()), a.endDate && N(e, a.endDate) > 0 && (e = t(a.endDate).toDate())), e
        }
        ...
        var re, se, ie = ee(), oe = !1, de = this, le = e(de).get(0);
